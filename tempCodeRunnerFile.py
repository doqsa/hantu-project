...
async def main():
    ...
    # [★중요 수정] 전략 매니저에 token_manager를 전달해야 과거 데이터를 긁어올 수 있습니다.
    strategy_manager = StrategyManager(strategy_queue, order_queue, token_manager)
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"[경고] DB 큐에 {db_queue.qsize()}개 항목이 남아있지만, 강제 종료합니다.")
